...
fn unicode_char_to_tex(c: char) -> Option<String> {
    ...
    match c {
        ...
        '∅' => Some(r"\empty".to_string()),
        '∆' => Some(r"\mathop{ \Delta }".to_string()),
        '∇' => Some(r"\nabla".to_string()),
        '∈' => Some(r"\in".to_string()),
        '∊' => Some(r"\in".to_string()),
        '∋' => Some(r"\ni".to_string()),
        '∍' => Some(r"\ni".to_string()),
        '∎' => Some(r"\blacksquare".to_string()),
        ...
        '⊶' => Some(r"\origof".to_string()),
        '⊷' => Some(r"\image".to_string()),
        '⊸' => Some(r"\multimap".to_string()),
        '⊺' => Some(r"\intercal".to_string()),
        '⊻' => Some(r"\veebar".to_string()),
        '⊼' => Some(r"\barwedge".to_string()),
        '⊽' => Some(r"\bar{ \vee }".to_string()),
